            ...
            <el-table :data="list" border size="mini" style="margin:10px 0px 0px;width: 100%;text-align: center">
                ...
                <el-table-column fixed="right" label="操作" width="200" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button @click="$router.push('/fenxiao/xiugaiXiangqing?id='+scope.row.id+'&shopid='+scope.row.shopid)" size="mini" type="text">查看更多</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
